  ...
  <div>
    <div class="flex justify-between items-start">
      ...
      <PrimeButton
        ...
        icon="pi pi-refresh"
        title="Refresh"
        :disabled="setupStore.data.db.loading"
      />
    </div>
    ...
    <div v-else class="my-8">
      ...
      <Message class="mt-8" severity="info">
        Before continuing, please ensure that the information above is correct. If not, update it in
        the .env file. Click the following button to continue.
      </Message>
